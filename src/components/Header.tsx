...
import { Menu, X, ChevronDown, Calendar, TrendingUp, Cpu, Target, Tv, Video, GitBranch, Code2, BarChart3, Newspaper, Sparkles, Mail, Instagram, Users, Building2 } from 'lucide-react'
